inherited WSVoucherEditForm: TWSVoucherEditForm
  Left = 111
  Top = 138
  Width = 510
  Height = 345
  BorderIcons = [biSystemMenu, biMaximize]
  Caption = 'WSVoucherEditForm'
  Menu = MainMenu
  ...
  object ToolBar: TToolBar
    ...
    object VourcherExportBttn: TToolButton
      Left = 77
      Top = 2
      Action = VourcherExportAction
    end
  ...
  object GoodsLookup: TQLDBLookupComboBox
    Left = 104
    Top = 216
    Width = 145
    Height = 18
  ...
  object ActionList: TActionList
    ...
    object PageOptionsAction: TAction
      ...
      OnExecute = PageOptionsActionExecute
    end

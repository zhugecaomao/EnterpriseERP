inherited SLEdSaleDsctGTPForm: TSLEdSaleDsctGTPForm
  Left = -4
  Top = -4
  Width = 808
  Height = 580
  ...
  inherited DetailsPopupMenu: TPopupMenu
    ...
    object DiscountAddAct: TMenuItem
      Caption = #36861#21152#25240#25187'(&B)'
      ShortCut = 16450
      OnClick = DiscountAddActClick
    end
  end
  ...
  object adsDetail: TADODataSet
    ...
    object adsDetailAmount: TBCDField
      ...
      FieldName = 'Amount'
      OnChange = adsDetailAmountChange
      DisplayFormat = '#.00'
      currency = True
      Precision = 19
      Size = 5
    ...
    object adsDetailPriceRate: TFloatField
      ...
      FieldName = 'PriceRate'
      OnChange = adsDetailPriceRateChange
      DisplayFormat = '#.00%'
      EditFormat = '#.#'
    end
    ...
    object adsDetailPriceStandard: TFloatField
      DisplayLabel = #25240#21069#21333#20215
      FieldName = 'PriceStandard'
      DisplayFormat = '#,#.00'
      EditFormat = '#.#'
    end

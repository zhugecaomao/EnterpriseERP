inherited SLEdSaleSForm: TSLEdSaleSForm
  Left = 52
  Top = 49
  Width = 668
  Height = 461
  ...
  object LookPackUnit: TQLDBLookupComboBox [6]
    Left = 496
    Top = 201
    Width = 81
    Height = 18
  ...
  inherited ActionList: TActionList
    ...
    inherited FindAction: TAction [15]
    end
    inherited CloseAction: TAction [16]
    end
  end
  ...
  object PackUnit: TADODataSet
    ...
    CommandText = 
      ...
      'SUnit'#13#10'where RecordState<>'#39#21024#38500#39' and GoalUnitID=ID'
    Parameters = <>
    Left = 134
    Top = 239
  end

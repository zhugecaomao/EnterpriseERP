...
type
  TSLEdSaleBillAForm = class(TBaseVoucherEditForm)
    Label1: TLabel;
    Label2: TLabel;
    Label3: TLabel;
...
var
  SLEdSaleBillAForm: TSLEdSaleBillAForm;
...
{$R *.dfm}
procedure TSLEdSaleBillAForm.New;
begin
  inherited;
  ClientName.Open;
  EmployeeName.Open;
  ...
  adsSalesMaster.FieldByName('BillMode').Value:='代销开单';
...
procedure TSLEdSaleBillAForm.Open(VoucherID: Integer);
begin
...
procedure TSLEdSaleBillAForm.FormClose(Sender: TObject;
...
procedure TSLEdSaleBillAForm.FormCreate(Sender: TObject);
begin
  inherited;
  VoucherTableName := 'SLSale';
end;

procedure TSLEdSaleBillAForm.FormShow(Sender: TObject);
begin
  inherited;
  ClientQLDBLookup.SetFocus;
end;

procedure TSLEdSaleBillAForm.ClientQLDBLookupEnter(Sender: TObject);
begin
  inherited;
  GEdit1.Enabled :=true;
  GEdit1.Text :='0';
...
procedure TSLEdSaleBillAForm.ClientQLDBLookupExit(Sender: TObject);
...
procedure TSLEdSaleBillAForm.DBComboBox3Change(Sender: TObject);
begin
  inherited;
...
procedure TSLEdSaleBillAForm.GoodsIDChange;
begin
  TempAds.Close;   //取标准单位
...
procedure TSLEdSaleBillAForm.QuantityChange;
begin
...
procedure TSLEdSaleBillAForm.adsSalesDetailPackUnitIDChange(Sender: TField);
begin
  inherited;
  adsSalesDetail.FieldByName('GoalQuantity').ReadOnly :=False;
  adsSalesDetail.FieldByName('GoalQuantity').AsFloat :=
...
procedure TSLEdSaleBillAForm.adsSalesDetailQuantityChange(Sender: TField);
begin
  inherited;
  QuantityChange;
end;

procedure TSLEdSaleBillAForm.adsSalesDetailGoodsIDChange(Sender: TField);
begin
  inherited;
  GoodsIDChange;
end;

procedure TSLEdSaleBillAForm.SaveActionExecute(Sender: TObject);
var adoTemp: TADOQuery;
    code:string;
begin
  inherited;
...
procedure TSLEdSaleBillAForm.ImportActionExecute(Sender: TObject);
begin
  inherited;
...
procedure TSLEdSaleBillAForm.LastPriceExecute(Sender: TObject);
begin
  inherited;
...
procedure TSLEdSaleBillAForm.DiscountModeExecute(Sender: TObject);
begin
  inherited;

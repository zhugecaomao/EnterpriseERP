inherited SLEdSaleBKForm: TSLEdSaleBKForm
  Left = 150
  Top = 149
  Width = 668
  Height = 461
  ...
  object LookupGoodsSpec: TQLDBLookupComboBox [8]
    Left = 244
    Top = 202
    Width = 89
    Height = 18
  ...
  inherited ActionList: TActionList
    ...
    inherited FindAction: TAction [12]
    end
    inherited SubmitAction: TAction [13]
      ImageIndex = 8
    end
    inherited SendAsMailAction: TAction [14]
      ImageIndex = 8
    end
    inherited ImportAction: TAction [15]
      ImageIndex = 13
      OnExecute = ImportActionExecute
    end
    object DiscountMode: TAction [16]
  ...
  object adsMaster: TADODataSet
    ...
    object adsMasterBillModeDC: TIntegerField

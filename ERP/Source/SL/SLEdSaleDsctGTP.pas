...
type
  TSLEdSaleDsctGTPForm = class(TBaseVoucherEditForm)
    Label1: TLabel;
    Label2: TLabel;
    Label3: TLabel;
...
var
  SLEdSaleDsctGTPForm: TSLEdSaleDsctGTPForm;
...
{$R *.dfm}
procedure TSLEdSaleDsctGTPForm.New;
begin
  inherited;
...
procedure TSLEdSaleDsctGTPForm.Open(VoucherID: Integer);
var
...
procedure TSLEdSaleDsctGTPForm.FormClose(Sender: TObject;
...
procedure TSLEdSaleDsctGTPForm.FormCreate(Sender: TObject);
...
procedure TSLEdSaleDsctGTPForm.adsDetailGoodsIDChange(Sender: TField);
...
procedure TSLEdSaleDsctGTPForm.adsDetailPackUnitIDChange(Sender: TField);
var ExChRate :real;
begin
  PackUnit.Locate('ID', adsDetail.fieldbyname('PackUnitID').AsString, []);
  if PackUnit.fieldbyname('ExchangeRate').IsNull then ExChRate :=1
...
procedure TSLEdSaleDsctGTPForm.NoCreditSaleClick(Sender: TObject);
begin
...
procedure TSLEdSaleDsctGTPForm.DBEdit6Enter(Sender: TObject);
begin
  DBEdit6.ReadOnly :=not NoCreditSale.Checked;
  if DBEdit6.ReadOnly then
  begin
...
procedure TSLEdSaleDsctGTPForm.InternalSave;
var adoTemp: TADOQuery;
...
procedure TSLEdSaleDsctGTPForm.DiscountTempActClick(Sender: TObject);
var RateStr:string;
  RateStrF :Double;
begin
  inherited;
...
procedure TSLEdSaleDsctGTPForm.DiscountAddActClick(Sender: TObject);
var RateStr:string;
  RateStrF :Double;
begin
  inherited;
...
procedure TSLEdSaleDsctGTPForm.adsDetailAmountChange(Sender: TField);
begin
  inherited;
  adsDetail.Edit;
  adsDetail.FieldByName('DiscountAmount').AsFloat :=
...
procedure TSLEdSaleDsctGTPForm.adsDetailPriceRateChange(Sender: TField);
begin
  inherited;
  adsDetail.Edit;
  adsDetail.FieldByName('PriceGoal').AsFloat :=
...
procedure TSLEdSaleDsctGTPForm.RepeatPrintActionExecute(Sender: TObject);
var RateStr:string;
  RateStrF :Double;
begin
  inherited;

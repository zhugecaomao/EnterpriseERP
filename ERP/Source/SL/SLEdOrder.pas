...
type
  TSLEdOrderForm = class(TBaseVoucherEditForm)
    Label1: TLabel;
    Label2: TLabel;
    Label3: TLabel;
...
procedure TSLEdOrderForm.Open(VoucherID: Integer);
begin
  inherited Open(VoucherID);
end;


procedure TSLEdOrderForm.FormClose(Sender: TObject;
...
procedure TSLEdOrderForm.FormCreate(Sender: TObject);
...
procedure TSLEdOrderForm.ClientQLDBLookupExit(Sender: TObject);
...
procedure TSLEdOrderForm.ClientQLDBLookupEnter(Sender: TObject);
begin
  inherited;
  GEdit1.Enabled :=true;
  GEdit1.Text :='0';
...
procedure TSLEdOrderForm.adsDetailGoodsIDChange(Sender: TField);
...
procedure TSLEdOrderForm.adsDetailQuantityChange(Sender: TField);
var   ExChRate :real;
begin
...
procedure TSLEdOrderForm.LookupPackUintEnter(Sender: TObject);
...
procedure TSLEdOrderForm.FormActivate(Sender: TObject);
begin
  inherited;
  ClientQLDBLookup.SetFocus;
end;

procedure TSLEdOrderForm.LookupPackUintExit(Sender: TObject);
begin

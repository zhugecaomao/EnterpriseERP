inherited SLEdSaleClientGTPForm: TSLEdSaleClientGTPForm
  Left = 34
  Top = 144
  Width = 668
  Height = 461
  ...
  object adsMaster: TADODataSet
    ...
    Filtered = True
    CommandText = 
      'select *'#13#10'from SLSaleClientMaster'#13#10'where RecordState<>'#39#21024#38500#39' and I' +
      'D=:ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
  ...
  object adsDetail: TADODataSet
    ...
    CommandText = 'select *'#13#10'from SLSaleClientDetail'#13#10'where MasterID = :ID'
    Parameters = <
      item
        Name = 'ID'

inherited SLEdContractPriceForm: TSLEdContractPriceForm
  Left = -6
  Top = -2
  Width = 808
  Height = 580
  ...
  inherited TopPanel: TPanel
    ...
    object Label9: TLabel [6]
      ...
      Width = 48
      Height = 12
      Caption = #21512#21516#31867#21035
    end
  ...
  inherited ActionList: TActionList
    ...
    object HoldOnPriceAction: TAction
      Caption = #21830#21697#21333#20215#36830#32493
      Hint = #23558#24403#21069#21830#21697#21333#20215#36830#32493#36171#32473#20197#19978#21830#21697#12290
      ImageIndex = 12
      ShortCut = 16456
      OnExecute = HoldOnPriceActionExecute
    end
  end
  ...
  object adsMaster: TADODataSet
    ...
    Filtered = True
    CommandText = 
      'select *'#13#10'from SLContractPriceMaster'#13#10'where RecordState<>'#39#21024#38500#39' an' +
      'd ID=:ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
  ...
  object adsDetail: TADODataSet
    ...
    CommandText = 'select *'#13#10'from  SLContractpriceDetail'#13#10'where MasterID = :ID'
    Parameters = <
      item
        Name = 'ID'
    ...
    object adsDetailPriceGoal: TBCDField
      DisplayLabel = #26631#20934#21806#20215
      FieldName = 'PriceGoal'
      EditFormat = '#.#'
      currency = True
      Precision = 19
    ...
    object adsDetailPriceClear: TBCDField
      DisplayLabel = #21442#32771#21806#20215
      FieldName = 'PriceClear'
      DisplayFormat = '#,#.00'
      EditFormat = '#.#'
      Precision = 19
    ...
    object adsDetailPriceMin: TBCDField
      DisplayLabel = #26368#20302#21806#20215
      FieldName = 'PriceMin'
      DisplayFormat = '#.00'
      EditFormat = '#.#'
      Precision = 19

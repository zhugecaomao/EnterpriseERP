inherited SLBrDiscountForm: TSLBrDiscountForm
  Left = -4
  Top = -4
  Width = 808
  Height = 580
  ...
  inherited Panel1: TPanel
    ...
    inherited PageControl: TPageControl
      ...
      inherited TabSheet1: TTabSheet
        Caption = #38144#21806#25240#25187#36164#26009
      end
    end
    inherited DBGrid: TQLDBGrid
      ...
      Columns = <
        ...
        item
          Expanded = False
          FieldName = #25240#25187#31867#21035
          Title.Alignment = taCenter
          Width = 100
          Visible = True
        end
  ...
  object tblSLBrContractPrice: TADODataSet
    ...
    CommandText = 
      ...
      'lientID,'#13#10'a.Date ['#26085#26399'], a.Code ['#32534#21495'], '#13#10'a.ContractClass ['#25240#25187#31867#21035'],  '#13 +
      ...
      'Memo ['#22791#27880'],'#13#10'a.RecordState ['#20973#21333#29366#24577']'#13#10'from SLSaleDiscountMaster a '#13#10 +
      'left outer join DAClient   b  on b.ID=a.ClientID'#13#10'where b.Record' +

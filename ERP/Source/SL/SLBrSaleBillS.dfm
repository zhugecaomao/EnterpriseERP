inherited SLBrSaleBillSForm: TSLBrSaleBillSForm
  Left = 49
  Top = 149
  Width = 697
  Height = 336
  Caption = #29305#33394#38144#21806#24320#21333
  ...
  object adsSalesMaster: TADODataSet
    ...
    CommandText = 
      ...
      '=a.id '#13#10'WHERE  A.RECORDSTATE<>'#39#21024#38500#39' '#13#10'order by a.ID DESC'
    Parameters = <>
    Left = 188
    Top = 108

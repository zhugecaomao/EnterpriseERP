inherited SLEdSalePriceForm: TSLEdSalePriceForm
  Left = -2
  Top = -4
  Width = 808
  Height = 580
  Caption = #21830#21697#21806#20215
  ...
  inherited TopPanel: TPanel
    ...
    object Label9: TLabel [6]
      ...
      Width = 48
      Height = 12
      Caption = #21806#20215#31867#21035
    end
  ...
  object adsMaster: TADODataSet
    ...
    Filtered = True
    CommandText = 
      'select *'#13#10'from SLSalePriceMaster'#13#10'where RecordState<>'#39#21024#38500#39' and ID' +
      '=:ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
  ...
  object adsDetail: TADODataSet
    ...
    CommandText = 'select *'#13#10'from  SLSalePriceDetail'#13#10'where MasterID = :ID'
    Parameters = <
      item
        Name = 'ID'

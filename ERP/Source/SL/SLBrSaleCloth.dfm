inherited SLBrSaleClothForm: TSLBrSaleClothForm
  Left = -4
  Top = -4
  Width = 808
  Height = 580
  ...
  object adsMaster: TADODataSet
    ...
    CommandText = 
      ...
      'ode as ['#32534#21495'],a.Date ['#26085#26399'],  a.BillMode ['#19994#21153#31867#21035'],'#13#10'b.name as ['#23458#25143#21517#31216'],'#13 +
      #10'ttl.Amount*a.ModeDC*a.ModeC as ['#38144#21806#37329#39069'] ,'#13#10'A.SundryFee*a.ModeDC*a' +
      '.ModeC  as ['#38468#21152#36153#29992'] ,'#13#10'a.ClearDate ['#32467#31639#26085#26399'], '#13#10'c.name as ['#32463#25163#20154'], '#13#10'a.' +
      'Deliver ['#36865#36135#35201#27714'], '#13#10'a.Memo ['#22791#27880'],'#13#10'a.Recordstate as ['#20973#21333#29366#24577']'#13#10'from SL' +
      'SaleMaster a '#13#10'left outer join  DAClient b on b. ID=a.ClientID '#13 +
      #10'left outer join  MSEmployee  c on c.id=a. EmployeeID   '#13#10'left o' +
      'uter join '#13#10'(select masterID, (sum(isnull(Amount,0))+Sum(Isnull(' +
      ...
      ' as ttl '#13#10'on ttl.masterID=a.id '#13#10'WHERE  A.RECORDSTATE<>'#39#21024#38500#39' '#13#10'or' +
      'der by a.ID DESC'
    Parameters = <>
    Left = 192
    Top = 108

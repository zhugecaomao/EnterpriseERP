inherited SLSaleForeCastForm: TSLSaleForeCastForm
  ...
  object TempAds: TADODataSet
    ...
    Filtered = True
    CommandText = 
      'select  ClientID,'#13#10'c.name  ,'#13#10'b.name Client,'#13#10'c.name Employee,'#13#10 +
      'SundryFee PeriodA, '#13#10'SundryFee PeriodB, '#13#10'SundryFee PeriodC,  '#13#10 +
      'SundryFee PeriodD,   '#13#10'SundryFee PeriodE, '#13#10'SundryFee PeriodF,  ' +
      '  '#13#10'SundryFee PeriodG,  '#13#10'SundryFee  PeriodTTL '#13#10'from SLSalemast' +
      'er  AS A  '#13#10'LEFT OUTER JOIN DAClient as b  on a.ClientID=b.id '#13#10 +
      'LEFT OUTER JOIN MSEmployee as c  on a.EmployeeID=c.id'#13#10'where 1=3'
    Parameters = <>
    Left = 364
    Top = 244
    object TempAdsClientID: TIntegerField
      FieldName = 'ClientID'
    end
    object TempAdsname: TStringField
      FieldName = 'name'
      Size = 30
    end
    object TempAdsClient: TStringField
      FieldName = 'Client'
      Size = 50
    end
    object TempAdsEmployee: TStringField
      FieldName = 'Employee'
      Size = 30
    end
    object TempAdsPeriodA: TBCDField
      FieldName = 'PeriodA'
      Precision = 19
      Size = 5
    end
    object TempAdsPeriodB: TBCDField
      FieldName = 'PeriodB'
      Precision = 19
      Size = 5
    end
    object TempAdsPeriodC: TBCDField
      FieldName = 'PeriodC'
      Precision = 19
      Size = 5
    end
    object TempAdsPeriodD: TBCDField
      FieldName = 'PeriodD'
      Precision = 19
      Size = 5
    end
    object TempAdsPeriodE: TBCDField
      FieldName = 'PeriodE'
      Precision = 19
      Size = 5
    end
    object TempAdsPeriodF: TBCDField
      FieldName = 'PeriodF'
      Precision = 19
      Size = 5
    end
    object TempAdsPeriodG: TBCDField
      FieldName = 'PeriodG'
      Precision = 19
      Size = 5
    end
    object TempAdsPeriodTTL: TBCDField
      FieldName = 'PeriodTTL'
      Precision = 19
      Size = 5
    end

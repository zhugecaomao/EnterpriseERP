inherited FAEdAssetRePlanForm: TFAEdAssetRePlanForm
  Left = -4
  Top = -4
  Width = 808
  Height = 580
  Caption = #36164#20135#32500#20462#35745#21010
  ...
  inherited DBGrid: TQLDBGrid
    ...
    Columns = <
      item
        ...
        Title.Caption = #36164#20135#21517#31216'['#26126#32454']'
        Width = 165
        Visible = True
      end
      item
      ...
      item
        ...
        FieldName = 'Amount'
        Title.Alignment = taCenter
        Title.Caption = #32500#20462#35745#21010#36153#29992
        Width = 104
        Visible = True
      end
      item
        ...
        FieldName = 'Memo'
        Title.Alignment = taCenter
        Title.Caption = #32500#20462#35745#21010#22791#27880
        Width = 367
        Visible = True
      end>
  end
  ...
  object adsMaster: TADODataSet
    ...
    Filtered = True
    CommandText = 
      'select *'#13#10'from  FAAssetRePlanMaster'#13#10'where RecordState<>'#39#21024#38500#39' and' +
      ' ID=:ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
  ...
  object adsDetail: TADODataSet
    ...
    CommandText = 'select *'#13#10'from FAAssetRePlanDetail'#13#10'where MasterID = :ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
        Name = 'ID'

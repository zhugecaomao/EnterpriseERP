...
type
  TFABrAssetRepairForm = class(TWSVoucherBrowseForm)
...
var
  FABrAssetRepairForm: TFABrAssetRepairForm;

implementation

uses CommonDM,FAEdAssetRepair;

{$R *.dfm}

function TFABrAssetRepairForm.CreateEditForm: TWSEditForm;
begin
  Result := TFAEdAssetRepairForm.Create(Self);
end;

procedure TFABrAssetRepairForm.FormCreate(Sender: TObject);
begin
  inherited;
  adsSalesMaster.Open;
end;

procedure TFABrAssetRepairForm.FormClose(Sender: TObject;
...
procedure TFABrAssetRepairForm.AddNewActionExecute(Sender: TObject);
begin
  inherited;
  adsSalesMaster.Requery();
end;

procedure TFABrAssetRepairForm.EditActionExecute(Sender: TObject);
begin
  inherited;
  adsSalesMaster.Requery();
end;

procedure TFABrAssetRepairForm.RefreshActionExecute(Sender: TObject);
begin
  inherited;
  UpdateDBGrid;
end;

procedure TFABrAssetRepairForm.UpdateDBGrid;
var  I: Integer;
begin
  with DBGrid do
  begin
...
procedure TFABrAssetRepairForm.FiltrateActionExecute(Sender: TObject);
begin
  inherited;
  UpdateDBGrid;
end;

inherited FABrAssetRepairForm: TFABrAssetRepairForm
  Left = 34
  Top = 94
  Width = 714
  Height = 466
  Caption = #36164#20135#32500#20462#31649#29702
  ...
  inherited Panel1: TPanel
    ...
    inherited PageControl: TPageControl
      ...
      inherited TabSheet1: TTabSheet
        Caption = #36164#20135#32500#20462#36164#26009
      end
    end
    inherited DBGrid: TQLDBGrid
      ...
      Columns = <
        ...
        item
          ...
          Title.Alignment = taCenter
          Title.Caption = #32500#20462#31867#21035
          Width = 120
          Visible = True
        end
        item
        ...
        item
          Expanded = False
          FieldName = #32500#20462#36153#29992
          Title.Alignment = taCenter
          Visible = True
        end
        item
        ...
        item
          ...
          Title.Alignment = taCenter
          Title.Caption = #32500#20462#35828#26126
          Width = 120
          Visible = True
        end
        item
  ...
  object adsSalesMaster: TADODataSet
    ...
    CommandText = 
      ...
      '['#32534#21495'],a.Date ['#26085#26399'],  a.BillMode ['#19994#21153#31867#21035'],d.Brief  ['#36164#20135#21517#31216'],'#13#10' a.ClearD' +
      ...
      'b.name as ['#37096#38376#21517#31216'] '#13#10',c.name as ['#32463#25163#20154'],a.sundryfee as ['#22788#32622#22238#25910#37329#39069'],'#13#10'tt' +
      'l.Amount*a.ModeDC*a.ModeC as ['#37329#39069'] ,'#13#10'A.RECORDSTATE as ['#36164#20135#29366#24577']'#13#10'fr' +
      'om FAAssetRepairMaster a '#13#10'left outer join   MSDepartment b on b' +
      '. ID=a.ClientID '#13#10'left outer join  MSEmployee  c on c.id=a. Empl' +
      'oyeeID   '#13#10'left outer join  FAAssetAddMaster D on d.id=a.OriginI' +
      'D    '#13#10'left outer join '#13#10'(select masterID, sum(isnull(Amount,0))' +
      '  as Amount '#13#10'from FAAssetRepairDetail group by masterId  ) as t' +
      'tl '#13#10'on ttl.masterID=a.id '#13#10'WHERE  A.RECORDSTATE<>'#39#21024#38500#39' '#13#10'order b' +
      'y a.ID DESC'
    Parameters = <>
    Left = 192
    Top = 108
    ...
    object adsSalesMasterDSDesigner13: TBCDField
      FieldName = #22788#32622#22238#25910#37329#39069
      DisplayFormat = '#,#.00'
      Precision = 19
      Size = 5
    end

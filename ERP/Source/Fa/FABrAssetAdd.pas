...
type
  TFABrAssetAddForm = class(TWSVoucherBrowseForm)
...
var
  FABrAssetAddForm: TFABrAssetAddForm;

implementation

uses CommonDM,FAEdAssetAdd;

{$R *.dfm}

function TFABrAssetAddForm.CreateEditForm: TWSEditForm;
begin
  Result := TFAEdAssetAddForm.Create(Self);
end;

procedure TFABrAssetAddForm.FormCreate(Sender: TObject);
begin
  inherited;
  adsSalesMaster.Open;
end;

procedure TFABrAssetAddForm.FormClose(Sender: TObject;
...
procedure TFABrAssetAddForm.AddNewActionExecute(Sender: TObject);
begin
  inherited;
  adsSalesMaster.Requery();
end;

procedure TFABrAssetAddForm.EditActionExecute(Sender: TObject);
begin
  inherited;
  adsSalesMaster.Requery();
end;

procedure TFABrAssetAddForm.RefreshActionExecute(Sender: TObject);
begin
  inherited;
  UpdateDBGrid;
end;

procedure TFABrAssetAddForm.UpdateDBGrid;
var  I: Integer;
begin
  with DBGrid do
  begin
...
procedure TFABrAssetAddForm.FiltrateActionExecute(Sender: TObject);
begin
  inherited;
  UpdateDBGrid;
end;

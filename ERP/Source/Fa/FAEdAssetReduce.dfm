inherited FAEdAssetReduceForm: TFAEdAssetReduceForm
  Left = -4
  Top = -4
  Width = 808
  Height = 580
  Caption = #36164#20135#22788#32622
  ...
  inherited TopPanel: TPanel
    ...
    object Label6: TLabel [6]
      ...
      Width = 72
      Height = 12
      Caption = #36164#20135#22788#32622#26041#24335
    end
    ...
    object Label10: TLabel [8]
      ...
      Width = 72
      Height = 12
      Caption = #22788#32622#22238#25910#36164#37329
    end
  ...
  object adsMaster: TADODataSet
    ...
    Filtered = True
    CommandText = 
      'select *'#13#10'from FAAssetReduceMaster'#13#10'where RecordState<>'#39#21024#38500#39' and ' +
      'ID=:ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
  ...
  object adsDetail: TADODataSet
    ...
    CommandText = 'select *'#13#10'from FAAssetReduceDetail'#13#10'where MasterID = :ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
        Name = 'ID'

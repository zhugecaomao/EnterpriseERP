inherited FNBrClearSLForm: TFNBrClearSLForm
  Left = 79
  Top = 134
  Width = 697
  Height = 522
  Caption = #38144#21806#32467#31639#31649#29702
  ...
  inherited Panel1: TPanel
    ...
    inherited PageControl: TPageControl
      ...
      inherited TabSheet1: TTabSheet
        Caption = #25910#27454#32467#31639#36164#26009
      end
    end
  ...
  object adsSLBrClearBill: TADODataSet
    ...
    CommandText = 
      ...
      ' ['#26085#26399'], f.Code as ['#32534#21495'], f.BillMode as ['#19994#21153#31867#21035'],'#13#10'C.name as ['#23458#25143'/'#21378#21830#21517#31216 +
      '] , FA.NAME AS ['#24080#25143#21517#31216'],'#13#10'Isnull(f.AmountD,0)*Isnull(f.ModeDC,1)*I' +
      'snull(f.ModeC,1)  as ['#25910#27454#37329#39069'],'#13#10'Isnull(f. AmountRed,0)*Isnull(f.Mo' +
      'deDC,1)*Isnull(f.ModeC,1)  as ['#25240#25187#36820#21033#37329#39069'], '#13#10'E.name as ['#32463#25163#20154'] ,f.Bri' +
      'ef  as ['#19994#21153#25688#35201'], F.Memo  as ['#22791#27880'] ,'#13#10'F.RecordState as ['#20973#21333#29366#24577']'#13#10'from ' +
      'FNClearSLMaster F '#13#10'LEFT Outer join  MSEmployee E on E.ID=F.Empl' +
      'oyeeID'#13#10'LEFT Outer join  DAClient C on C.ID=F.ClientID'#13#10'LEFT Out' +
      'er join   FNAccounts  FA  on FA.ID=F.AccountsID '#13#10'where F.Record' +
      'State<>'#39#21024#38500#39' '#13#10'Order by F.ID desc '
    Parameters = <>
    Left = 140
    Top = 124

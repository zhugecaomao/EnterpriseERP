inherited FNBrCashInForm: TFNBrCashInForm
  Left = 70
  Top = 158
  Width = 697
  Height = 522
  ...
  object adsMaster: TADODataSet
    ...
    CommandText = 
      ...
      ' ['#26085#26399'], f.Code as ['#32534#21495'], f.BillMode as ['#19994#21153#31867#21035'],'#13#10'C.name as ['#20132#27454#20154'] , ' +
      'FA.NAME AS ['#24080#25143#21517#31216'],'#13#10'Isnull(f.AmountD,0)*Isnull(ModeDC,1)*Isnull(' +
      'ModeC,1)   as ['#25910#27454#37329#39069'],'#13#10'Isnull(f. AmountRed,0)*Isnull(ModeDC,1)*I' +
      'snull(ModeC,1)   as ['#20914#24080#37329#39069'], '#13#10'E.name as ['#32463#25163#20154'] ,f.Brief  as ['#19994#21153#25688#35201 +
      '], F.Memo  as ['#22791#27880'] ,'#13#10'F.RecordState as ['#20973#21333#29366#24577']'#13#10'from FNCashInMast' +
      'er F '#13#10'LEFT Outer join  MSEmployee E on E.ID=F.EmployeeID'#13#10'LEFT ' +
      'Outer join  MSEmployee  C on C.ID=F.ClientID'#13#10'LEFT Outer join   ' +
      'FNAccounts  FA  on FA.ID=F.AccountsID '#13#10'where F.RecordState<>'#39#21024#38500 +
      #39' '#13#10'Order by F.ID desc '#13#10#13#10
    Parameters = <>
    Left = 140
    Top = 124

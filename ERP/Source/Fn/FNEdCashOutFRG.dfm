inherited FNEdCashOutFRGForm: TFNEdCashOutFRGForm
  Left = 1
  Top = -2
  Width = 804
  Height = 576
  ...
  object adsMaster: TADODataSet
    ...
    Filtered = True
    CommandText = 
      'select *'#13#10'from   FNCashOutMaster'#13#10'where RecordState<>'#39#21024#38500#39' and ID' +
      '=:ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
  ...
  object adsDetail: TADODataSet
    ...
    CommandText = 'select *'#13#10'from  FNCashOutDetail '#13#10'where MasterID = :ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
        Name = 'ID'

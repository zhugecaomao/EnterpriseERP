...
type
  TFNEdCashInForm = class(TBaseVoucherEditAForm)
    Label1: TLabel;
    Label2: TLabel;
    Label3: TLabel;
...
var
  FNEdCashInForm: TFNEdCashInForm;
...
procedure TFNEdCashInForm.Open(VoucherID: Integer);
begin
  inherited Open(VoucherID);
end;


procedure TFNEdCashInForm.FormClose(Sender: TObject;
...
procedure TFNEdCashInForm.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TFNEdCashInForm.ClientQLDBLookupEnter(Sender: TObject);
begin
  inherited;
  GEdit1.Enabled :=true;
  GEdit1.Text :='0';
...
procedure TFNEdCashInForm.ClientQLDBLookupExit(Sender: TObject);
...
procedure TFNEdCashInForm.adsDetailExpenseIDChange(Sender: TField);
begin
  inherited;
  adsDetail.Edit;
...
procedure TFNEdCashInForm.FormActivate(Sender: TObject);
begin
  inherited;
  ClientQLDBLookup.SetFocus;
end;

procedure TFNEdCashInForm.FormShow(Sender: TObject);
begin
  inherited;
//  ClientQLDBLookup.SetFocus;
end;

...
type
  TFNEdClearSLFRGForm = class(TBaseVoucherEditAForm)
    Label1: TLabel;
    Label2: TLabel;
    Label3: TLabel;
...
var
  FNEdClearSLFRGForm: TFNEdClearSLFRGForm;
...
{$R *.dfm}
procedure TFNEdClearSLFRGForm.New;
begin
  inherited;
...
procedure TFNEdClearSLFRGForm.Open(VoucherID: Integer);
begin
  inherited Open(VoucherID);
end;


procedure TFNEdClearSLFRGForm.FormClose(Sender: TObject;
...
procedure TFNEdClearSLFRGForm.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TFNEdClearSLFRGForm.ClientQLDBLookupEnter(Sender: TObject);
begin
  inherited;
  GEdit1.Enabled :=true;
  GEdit1.Text :='0';
...
procedure TFNEdClearSLFRGForm.ClientQLDBLookupExit(Sender: TObject);
...
procedure TFNEdClearSLFRGForm.BitBtn1Click(Sender: TObject);
var amount:real;
begin
  inherited;
  amount :=0;
...
procedure TFNEdClearSLFRGForm.adsDetailOriginIDChange(Sender: TField);
Var s:string;
begin
  inherited;
...
procedure TFNEdClearSLFRGForm.FormActivate(Sender: TObject);
...
procedure TFNEdClearSLFRGForm.FormShow(Sender: TObject);
begin
  inherited;
  adsCode.Open;
end;

procedure TFNEdClearSLFRGForm.LookUpAccountExit(Sender: TObject);
var StrAccountID :string;
begin
  inherited;
  StrAccountID := adsMaster.fieldbyname('AccountsID').AsString;
...
procedure TFNEdClearSLFRGForm.DBEdit4Exit(Sender: TObject);
begin
  inherited;

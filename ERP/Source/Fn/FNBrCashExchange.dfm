inherited FNBrCashExchangeForm: TFNBrCashExchangeForm
  Left = -4
  Top = -4
  Width = 808
  Height = 580
  Caption = #22806#24065#20817#25442#31649#29702
  ...
  inherited Panel1: TPanel
    ...
    inherited PageControl: TPageControl
      ...
      inherited TabSheet1: TTabSheet
        Caption = #22806#24065#20817#25442#36164#26009
      end
    end
    inherited DBGrid: TQLDBGrid
      ...
      Columns = <
        ...
        item
          Expanded = False
          FieldName = #20817#20986#24080#25143
          Title.Alignment = taCenter
          Width = 120
          Visible = True
        end
        item
          Expanded = False
          FieldName = #20817#20837#24080#25143
          Title.Alignment = taCenter
          Width = 120
          Visible = True
        end
  ...
  object adsMaster: TADODataSet
    ...
    CommandText = 
      ...
      ' ['#26085#26399'], f.Code as ['#32534#21495'], f.BillMode as ['#19994#21153#31867#21035'],'#13#10'C.name as ['#20817#20986#24080#25143'] ,' +
      ' FA.NAME AS ['#20817#20837#24080#25143'],'#13#10'Isnull(f.AmountD,0)*Isnull(f.ModeDC,1)*Isnu' +
      'll(f.ModeC,1)  as ['#26412#24065#37329#39069'],'#13#10'Isnull(f. AmountRed,0)*Isnull(f.ModeD' +
      ...
      'hExchangeMaster  F '#13#10'LEFT Outer join  MSEmployee E on E.ID=F.Emp' +
      'loyeeID'#13#10'LEFT Outer join  FNAccounts  C on C.ID=F.ClientID'#13#10'LEFT' +
      ' Outer join   FNAccounts  FA  on FA.ID=F.AccountsID '#13#10#13#10'where F.' +
      'RecordState<>'#39#21024#38500#39' '#13#10'Order by F.ID desc '#13#10#13#10
    Parameters = <>
    Left = 140
    Top = 124

inherited FNEdClearSLFRGForm: TFNEdClearSLFRGForm
  Left = 7
  Top = 243
  Width = 808
  Height = 580
  Caption = #25910#27454#32467#31639#21333
  ...
  inherited DBGrid: TQLDBGrid
    ...
    Columns = <
      item
        ...
        CustomControl = LookUpOriginCode
      end
      item
        Expanded = False
        FieldName = 'Amount'
  ...
  inherited TopPanel: TPanel
    ...
    object Label1: TLabel [3]
      ...
      Width = 78
      Height = 12
      Caption = #23458#25143'/'#21378#21830#21517#31216
    end
  ...
  object LookUpOriginCode: TQLDBLookupComboBox [7]
    Left = 8
    Top = 257
    Width = 117
    Height = 18
  ...
  object adsMaster: TADODataSet
    ...
    Filtered = True
    CommandText = 
      'select *'#13#10'from   FNClearSLMaster'#13#10'where RecordState<>'#39#21024#38500#39' and ID' +
      '=:ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
  ...
  object adsDetail: TADODataSet
    ...
    CommandText = 'select *'#13#10'from  FNClearSLDetail '#13#10'where MasterID = :ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
        Name = 'ID'
    ...
    object adsDetailOriginCode: TStringField
      DisplayLabel = #21407#22987#38144#21806#21333#21495
      FieldKind = fkLookup
      FieldName = 'OriginCode'

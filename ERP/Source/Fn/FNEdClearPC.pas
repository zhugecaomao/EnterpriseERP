...
type
  TFNEdClearPCForm = class(TBaseVoucherEditAForm)
    Label1: TLabel;
    Label2: TLabel;
    Label3: TLabel;
...
var
  FNEdClearPCForm: TFNEdClearPCForm;
...
{$R *.dfm}
procedure TFNEdClearPCForm.New;
begin
  inherited;
...
procedure TFNEdClearPCForm.Open(VoucherID: Integer);
begin
  inherited Open(VoucherID);
end;


procedure TFNEdClearPCForm.FormClose(Sender: TObject;
...
procedure TFNEdClearPCForm.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TFNEdClearPCForm.ClientQLDBLookupEnter(Sender: TObject);
begin
  inherited;
  GEdit1.Enabled :=true;
  GEdit1.Text :='0';
...
procedure TFNEdClearPCForm.ClientQLDBLookupExit(Sender: TObject);
...
procedure TFNEdClearPCForm.BitBtn1Click(Sender: TObject);
var amount:real;
begin
  inherited;
  amount :=0;
...
procedure TFNEdClearPCForm.adsDetailOriginIDChange(Sender: TField);
Var s:string;
begin
  inherited;
...
procedure TFNEdClearPCForm.FormActivate(Sender: TObject);
begin
  inherited;
  ClientQLDBLookup.SetFocus;
end;

procedure TFNEdClearPCForm.FormShow(Sender: TObject);
begin
  inherited;
//  ClientQLDBLookup.SetFocus;
end;

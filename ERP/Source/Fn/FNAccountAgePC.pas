...
type
  TFNAccountAgePCForm = class(TWSVoucherBrowseForm)
...
var
  FNAccountAgePCForm: TFNAccountAgePCForm;
...
function TFNAccountAgePCForm.CreateEditForm: TWSEditForm;
begin
//  Result := TSLEdClearBillAForm.Create(Self);
end;


procedure TFNAccountAgePCForm.BitBtn1Click(Sender: TObject);
var  DateStr :STRING;
begin
...
procedure TFNAccountAgePCForm.FormCreate(Sender: TObject);
begin
  inherited;
  DateTimePicker1.DateTime :=date;
end;

procedure TFNAccountAgePCForm.UpdateDBGrid;
var  I: Integer;
begin
  with DBGrid do
  begin
...
procedure TFNAccountAgePCForm.FormShow(Sender: TObject);
begin
  inherited;
//  BitBtn1Click(sender);
 DateTimePicker1.DateTime :=Date;
...
procedure TFNAccountAgePCForm.DBGridTitleClick(Column: TColumn);
begin
  inherited;
   UpdateDBGrid;
end;

procedure TFNAccountAgePCForm.Label2Click(Sender: TObject);
begin
  inherited;
  ComboBox1.SetFocus;
end;

procedure TFNAccountAgePCForm.FormActivate(Sender: TObject);

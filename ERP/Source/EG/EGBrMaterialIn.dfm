inherited EGBrMaterialInForm: TEGBrMaterialInForm
  Left = -4
  Top = -4
  Width = 808
  Height = 580
  Caption = #39033#30446#36827#26009
  ...
  inherited Panel1: TPanel
    ...
    inherited PageControl: TPageControl
      ...
      inherited TabSheet1: TTabSheet
        Caption = #39033#30446#36827#26009#36164#26009
      end
    end
    inherited DBGrid: TQLDBGrid
      ...
      Columns = <
        ...
        item
          ...
          Title.Alignment = taCenter
          Title.Caption = #26469#26009#21333#20301
          Width = 130
          Visible = True
        end
        item
  ...
  object adsMaster: TADODataSet
    ...
    CommandText = 
      ...
      'learDate ['#32467#31639#26085#26399'], a.Apportion ['#20998#25674#35201#27714'], '#13#10'a.Deliver ['#36865#36135#35201#27714'], a.Memo ' +
      '['#22791#27880'],b.name as ['#23458#25143#21517#31216'] '#13#10',c.name as ['#32463#25163#20154'], A.SundryFee*a.ModeDC*a' +
      '.ModeC  as ['#38468#21152#36153#29992'] ,'#13#10'ttl.Amount*a.ModeDC*a.ModeC as ['#37329#39069'] ,'#13#10'ttl.' +
      'Discount*a.ModeDC*a.ModeC as ['#25240#25187#37329#39069'],'#13#10'a.Recordstate as ['#20973#21333#29366#24577']'#13#10'f' +
      'rom EGMaterialInMaster  a '#13#10'left outer join  DAClient b on b. ID' +
      '=a.ClientID '#13#10'left outer join  MSEmployee  c on c.id=a. Employee' +
      'ID   '#13#10'left outer join '#13#10'(select masterID, (sum(isnull(Amount,0)' +
      ')+Sum(Isnull(TaxAmount,0))+'#13#10'Sum(Isnull(SundryFee,0))) as Amount' +
      ' ,sum(isnull(Discount,0)) as Discount'#13#10'from EGMaterialInDetail g' +
      'roup by masterID) as ttl '#13#10'on ttl.masterID=a.id '#13#10#13#10'left outer j' +
      'oin  STWareHouse f on f. ID=a.WareHouseID'#13#10#13#10'WHERE  A.RECORDSTAT' +
      'E<>'#39#21024#38500#39' '#13#10'order by a.ID DESC'
    Parameters = <>
    Left = 192
    Top = 108

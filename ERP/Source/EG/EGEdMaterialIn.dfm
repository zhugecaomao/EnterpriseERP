inherited EGEdMaterialInForm: TEGEdMaterialInForm
  Left = 8
  Top = 91
  Width = 808
  Height = 580
  Caption = #39033#30446#36827#26009#21333
  ...
  inherited TopPanel: TPanel
    ...
    object Label1: TLabel [3]
      ...
      Width = 48
      Height = 12
      Caption = #26469#26009#21333#20301
    end
    ...
    object Label6: TLabel [6]
      ...
      Width = 48
      Height = 12
      Caption = #36827#26009#20179#24211
    end
    ...
    object CheckBox1: TCheckBox
      ...
      Width = 73
      Height = 17
      Caption = #30452#25509#39046#26009
      Checked = True
      State = cbChecked
      TabOrder = 9
    end
  ...
  object PackUnit: TADODataSet
    ...
    CursorType = ctStatic
    CommandText = 
      'select ID, Name, ExchangeRate, GoalUnitID, IsGoalUnit'#13#10'from  MSU' +
      'nit'#13#10'where RecordState<>'#39#21024#38500#39' '
    Parameters = <>
    Left = 173
    Top = 239
  end
  ...
  object adsMaster: TADODataSet
    ...
    Filtered = True
    CommandText = 
      'select *'#13#10'from EGMaterialInMaster'#13#10'where RecordState<>'#39#21024#38500#39' and I' +
      'D=:ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
  ...
  object adsDetail: TADODataSet
    ...
    CommandText = 'select *'#13#10'from EGMaterialInDetail'#13#10'where MasterID = :ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
        Name = 'ID'
  ...
  object ADODataSet1: TADODataSet
    Connection = CommonData.acnConnection
    CommandText = 'select  from EGMaterialOutDetail'
    Parameters = <>
    Left = 544
    Top = 256
  end

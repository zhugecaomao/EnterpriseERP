...
type
  TDAMaterialEditForm = class(TWSStandardEditForm)
...
var
  DAMaterialEditForm: TDAMaterialEditForm;
...
{$R *.dfm}
function TDAMaterialEditForm.Enter(const Params: Variant): Boolean;
begin
  tblGoodsEdit.open;
  adotable1.open;
  adotable2.Open;
...
function TDAMaterialEditForm.Edit(const Params: Variant): Boolean;
begin
  tblGoodsEdit.open;
  adotable1.open;
  adotable2.Open;
...
procedure TDAMaterialEditForm.tblGoodsEditBeforePost(DataSet: TDataSet);
begin
  inherited;
...
procedure TDAMaterialEditForm.OKButtonClick(Sender: TObject);
begin
  inherited;
...
procedure TDAMaterialEditForm.CancelButtonClick(Sender: TObject);
begin
  inherited;
  ModalResult := mrCancel;
end;

procedure TDAMaterialEditForm.FormClose(Sender: TObject;
...
procedure TDAMaterialEditForm.DBImage1DblClick(Sender: TObject);
begin
  inherited;
...
procedure TDAMaterialEditForm.ADOTable1FilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
  inherited;
...
procedure TDAMaterialEditForm.tblGoodsEditFilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
  inherited;
...
procedure TDAMaterialEditForm.ADOTable2FilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
  inherited;
...
procedure TDAMaterialEditForm.FormShow(Sender: TObject);
begin
  inherited;
 dbedit1.SetFocus;
 dbedit1.SelLength:=0;
...
procedure TDAMaterialEditForm.DBLookupComboBox2Enter(Sender: TObject);
begin
  inherited;
  tblGoodsEdit.Edit;
...
procedure TDAMaterialEditForm.DBEdit1Exit(Sender: TObject);
begin
  inherited;
  tblGoodsEdit.Edit;
  if (tblGoodsEdit.FieldByName('UnitID').AsInteger =0) or
...
procedure TDAMaterialEditForm.AddUnitLookupCloseUp(Sender: TObject);
begin
  inherited;
  tblGoodsEdit.Edit;

inherited EGBrMaterialOutForm: TEGBrMaterialOutForm
  Left = -4
  Top = -4
  Width = 808
  Height = 580
    ...
    inherited DBGrid: TQLDBGrid
      ...
      Columns = <
        ...
        item
          ...
          Title.Alignment = taCenter
          Title.Caption = #20986#26009#20179#24211
          Visible = True
        end
        item
          Expanded = False
  ...
  object adsMaster: TADODataSet
    ...
    CommandText = 
      ...
      '['#22791#27880'],b.name as ['#39033#30446#21517#31216'] '#13#10',c.name as ['#32463#25163#20154'], A.SundryFee*a.ModeDC*a' +
      ...
      'rom EGMaterialOutMaster  a '#13#10'left outer join  DAProject b on b. ' +
      'ID=a.ClientID '#13#10'left outer join  MSEmployee  c on c.id=a. Employ' +
      'eeID   '#13#10'left outer join '#13#10'(select masterID, (sum(isnull(Amount,' +
      '0))+Sum(Isnull(TaxAmount,0))+'#13#10'Sum(Isnull(SundryFee,0))) as Amou' +
      'nt ,sum(isnull(Discount,0)) as Discount'#13#10'from EGMaterialOutDetai' +
      'l group by masterID) as ttl '#13#10'on ttl.masterID=a.id '#13#10#13#10'left oute' +
      'r join  STWareHouse f on f. ID=a.WareHouseID'#13#10#13#10'WHERE  A.RECORDS' +
      'TATE<>'#39#21024#38500#39' '#13#10'order by a.ID DESC'
    Parameters = <>
    Left = 192
    Top = 108

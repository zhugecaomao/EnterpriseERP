inherited EGBrFACReceiptForm: TEGBrFACReceiptForm
  Left = 10
  Top = 254
  Width = 808
  Height = 580
  ...
  inherited Panel1: TPanel
    ...
    inherited PageControl: TPageControl
      ...
      inherited TabSheet1: TTabSheet
        Caption = #21512#21516#39033#30446#27454#36164#26009
      end
    end
    inherited DBGrid: TQLDBGrid
      ...
      Columns = <
        ...
        item
          ...
          Title.Alignment = taCenter
          Title.Caption = #19994#20027'/'#23458#25143#21517#31216
          Width = 130
          Visible = True
        end
        item
  ...
  object adsMaster: TADODataSet
    ...
    CommandText = 
      ...
      'rom SLSaleMaster  a '#13#10'left outer join  DAClient b on b. ID=a.Cli' +
      'entID '#13#10'left outer join  MSEmployee  c on c.id=a. EmployeeID   '#13 +
      #10'left outer join '#13#10'(select masterID, (sum(isnull(Amount,0))+Sum(' +
      'Isnull(TaxAmount,0))+'#13#10'Sum(Isnull(SundryFee,0))) as Amount ,sum(' +
      'isnull(Discount,0)) as Discount'#13#10'from SLSaleDetail  group by mas' +
      'terID) as ttl '#13#10'on ttl.masterID=a.id '#13#10'left outer join  STWareHo' +
      'use f on f. ID=a.WareHouseID'#13#10'WHERE  A.RECORDSTATE<>'#39#21024#38500#39' '#13#10'order' +
      ' by a.ID DESC'
    Parameters = <>
    Left = 192
    Top = 108

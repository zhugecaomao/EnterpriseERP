unit BaseVoucherEdit;

interface

uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
  Dialogs, WSVoucherEdit, Menus, ActnList, DB, QLDBLkp, ComCtrls, StdCtrls,
  Mask, DBCtrls, ExtCtrls, ToolWin, Grids, DBGrids, QLDBGrid, QuickRpt;

type
  TBaseVoucherEditForm = class(TWSVoucherEditForm)
    CheckAction: TAction;
...
uses VoucherQuery, BaseVoucherRpt,VoucherImport;

{$R *.dfm}

procedure TBaseVoucherEditForm.SLActualPriceExecute(Sender: TObject);
begin
  inherited;
...
procedure TBaseVoucherEditForm.RedWordActionExecute(Sender: TObject);
var
  Field: TField;
begin
  inherited;
...
procedure TBaseVoucherEditForm.CheckActionExecute(Sender: TObject);
begin
  inherited;
  with MasterDataSet do
  begin
...
procedure TBaseVoucherEditForm.SLOrderTrailExecute(Sender: TObject);
begin
  inherited;
...
procedure TBaseVoucherEditForm.StockChangeExecute(Sender: TObject);
begin
  inherited;
...
procedure TBaseVoucherEditForm.SLsaleLegerExecute(Sender: TObject);
begin
  inherited;
...
procedure TBaseVoucherEditForm.SLClearLegerExecute(Sender: TObject);
begin
  inherited;
...
procedure TBaseVoucherEditForm.SLCreditExecute(Sender: TObject);
begin
  inherited;
...
procedure TBaseVoucherEditForm.PCCreditExecute(Sender: TObject);
begin
  inherited;
...
procedure TBaseVoucherEditForm.SalePriceExecute(Sender: TObject);
begin
  inherited;
...
procedure TBaseVoucherEditForm.PurchasePriceExecute(Sender: TObject);
begin
  inherited;
...
procedure TBaseVoucherEditForm.SLContractPriceExecute(Sender: TObject);
begin
  inherited;
...
procedure TBaseVoucherEditForm.PCContractPriceExecute(Sender: TObject);
begin
  inherited;
...
procedure TBaseVoucherEditForm.PCOrderTrailExecute(Sender: TObject);
begin
  inherited;
...
procedure TBaseVoucherEditForm.PCActualPriceExecute(Sender: TObject);
begin
  inherited;
...
procedure TBaseVoucherEditForm.PCClearLegerExecute(Sender: TObject);
begin
  inherited;
...
procedure TBaseVoucherEditForm.CashBalanceExecute(Sender: TObject);
begin
  inherited;
...
procedure TBaseVoucherEditForm.PCPurchaseLegerExecute(Sender: TObject);
begin
  inherited;
  ShowQueryForm(SLsaleLeger.Caption,SLsaleLeger.Hint,
        ' select a.Code as [编号],a.Date as [日期],    '
...
procedure TBaseVoucherEditForm.ActualStockExecute(Sender: TObject);
...
begin
  ...
  ShowQueryForm(ActualStock.Caption,ActualStock.Hint, 'select '
        +' w.name as [仓库名称] ,                           '
        +' E.name as [商品名称],       '
        +' sum(isnull(b.Quantity,0))  as [包装数量],            '
        +' f.name as  [包装单位],                           '
...
procedure TBaseVoucherEditForm.ReceiptPayableExecute(Sender: TObject);
begin
  inherited;
//
end;

procedure TBaseVoucherEditForm.EmployeeLendExecute(Sender: TObject);
begin
  inherited;
...
function TBaseVoucherEditForm.CreateReport: TQuickRep;
begin
  Result := TBaseVoucherReport.Create(Self);
  TBaseVoucherReport(Result).SetMasterDataSet(MasterDataSet);
end;

procedure TBaseVoucherEditForm.StockConsignExecute(Sender: TObject);
begin
  inherited;
...
procedure TBaseVoucherEditForm.UpdateDBGrid;
var  I: Integer;
begin
  with DBGrid do
  begin
...
procedure TBaseVoucherEditForm.FormShow(Sender: TObject);
begin
  inherited;
//  UpdateDBGrid;
end;

procedure TBaseVoucherEditForm.YDPurchasePlanExecute(Sender: TObject);
begin
  inherited;

inherited PCEdGoodsInBGTPForm: TPCEdGoodsInBGTPForm
  Left = 18
  Top = 175
  Width = 808
  Height = 580
  Caption = #36864#36135#20986#24211#21333
  ...
  inherited TopPanel: TPanel
    ...
    object Label1: TLabel [3]
      ...
      Width = 72
      Height = 12
      Caption = #20132#36135#21378#21830#21517#31216
    end
  ...
  object adsMaster: TADODataSet
    ...
    Filtered = True
    CommandText = 
      'select *'#13#10'from PCGoodsInMaster'#13#10'where RecordState<>'#39#21024#38500#39' and ID=:' +
      'ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
  ...
  object adsDetail: TADODataSet
    ...
    CommandText = 'select *'#13#10'from PCGoodsInDetail'#13#10'where MasterID = :ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
        Name = 'ID'

inherited PCEdContractPriceForm: TPCEdContractPriceForm
  Left = -6
  Top = -3
  Width = 809
  Height = 581
  ...
  object adsMaster: TADODataSet
    ...
    Filtered = True
    CommandText = 
      'select *'#13#10'from PCContractPriceMaster'#13#10'where RecordState<>'#39#21024#38500#39' an' +
      'd ID=:ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
  ...
  object adsDetail: TADODataSet
    ...
    CommandText = 'select *'#13#10'from  PCContractpriceDetail'#13#10'where MasterID = :ID'
    Parameters = <
      item
        Name = 'ID'
    ...
    object adsDetailPriceMin: TBCDField
      DisplayLabel = #26368#20302#36827#20215
      FieldName = 'PriceMin'
      DisplayFormat = '#.00'
      EditFormat = '#.#'
      Precision = 19

...
type
  TPCPurchasePriceForm = class(TWSStandardEditForm)
...
function TPCPurchasePriceForm.Enter: Boolean;
begin
...
function TPCPurchasePriceForm.Edit(const Params: Variant): Boolean;
begin
      tblSLEdBuyPrice.open ;
   adoquery1.Open;
...
procedure TPCPurchasePriceForm.OKButtonClick(Sender: TObject);
begin
  inherited;
...
procedure TPCPurchasePriceForm.CancelButtonClick(Sender: TObject);
begin
  inherited;
   modalresult:=mrcancel;
end;

procedure TPCPurchasePriceForm.FormClose(Sender: TObject;
...
procedure TPCPurchasePriceForm.tblSLEdBuyPriceBeforeOpen(DataSet: TDataSet);
begin
  inherited;
...
procedure TPCPurchasePriceForm.FormShow(Sender: TObject);
begin
  inherited;

inherited PCEdPurchasePriceForm: TPCEdPurchasePriceForm
  Left = -22
  Top = 28
  Width = 808
  Height = 580
  ...
  object adsMaster: TADODataSet
    ...
    Filtered = True
    CommandText = 
      'select *'#13#10'from PCPurchasePriceMaster'#13#10'where RecordState<>'#39#21024#38500#39' an' +
      'd ID=:ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
  ...
  object adsDetail: TADODataSet
    ...
    CommandText = 'select *'#13#10'from  PCPurchasePriceDetail'#13#10'where MasterID = :ID'
    Parameters = <
      item
        Name = 'ID'
    ...
    object adsDetailPriceGoal: TBCDField
      DisplayLabel = #26631#20934#36827#20215
      FieldName = 'PriceGoal'
      Visible = False
      EditFormat = '#.#'
      currency = True

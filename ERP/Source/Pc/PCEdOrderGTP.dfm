inherited PCEdOrderGTPForm: TPCEdOrderGTPForm
  Left = 103
  Top = 164
  Width = 668
  Height = 461
  ...
  inherited TopPanel: TPanel
    ...
    object Label1: TLabel [3]
      ...
      Width = 48
      Height = 12
      Caption = #35746#36141#21378#21830
    end
  ...
  object adsMaster: TADODataSet
    ...
    CursorType = ctStatic
    Filtered = True
    CommandText = 'select *'#13#10'from PCOrderMaster'#13#10'where RecordState<>'#39#21024#38500#39' and ID=:ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
        Name = 'ID'
  ...
  object adsDetail: TADODataSet
    ...
    CommandText = 'select *'#13#10'from PCOrderDetail'#13#10'where MasterID = :ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
        Name = 'ID'

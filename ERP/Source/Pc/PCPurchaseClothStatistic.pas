...
type
  TPCPurchaseClothStatisticForm = class(TWSVoucherBrowseForm)
...
var
  PCPurchaseClothStatisticForm: TPCPurchaseClothStatisticForm;
...
function TPCPurchaseClothStatisticForm.CreateEditForm: TWSEditForm;
begin
//  Result := TSLEdClearBillAForm.Create(Self);
end;


procedure TPCPurchaseClothStatisticForm.UpdateDBGrid;
var I: Integer;
begin
  with DBGrid do
  begin
...
procedure TPCPurchaseClothStatisticForm.DBGridTitleClick(Column: TColumn);
begin
  inherited;
  UpdateDBGrid;
end;

procedure TPCPurchaseClothStatisticForm.DBGridDblClick(Sender: TObject);
begin
// inherited;
end;


procedure TPCPurchaseClothStatisticForm.Button3Click(Sender: TObject);
begin
  inherited;
...
procedure TPCPurchaseClothStatisticForm.FormShow(Sender: TObject);
var I :integer;
begin
  inherited;
  ADOQuery.Close;
  ...
  ADOQuery.SQL.Text :=' select b.Date [日期], '
      ...
      +' a.GoodsSpec [规格型号],               '
      +' a.CapStyle [杯型],               '
      +' Isnull(a.SizeA,0)*Isnull(b.ModeDC,1)*Isnull(b.ModeC,1) [Ｓ],  '   //
      +' Isnull(a.SizeB,0)*Isnull(b.ModeDC,1)*Isnull(b.ModeC,1) [Ｍ],  '
      +' Isnull(a.SizeC,0)*Isnull(b.ModeDC,1)*Isnull(b.ModeC,1) [Ｌ],  '
      ...
      +' Isnull(a.QuantityPcs,0)*Isnull(b.ModeDC,1)*Isnull(b.ModeC,1) [均码],                  '
...
procedure TPCPurchaseClothStatisticForm.Button1Click(Sender: TObject);
begin
  Panel6.Visible :=True;
  Panel6.Repaint;
  Button1.Tag:=1 ;
...
procedure TPCPurchaseClothStatisticForm.FormActivate(Sender: TObject);
begin
  inherited;
  ADOQuery.Close;
...
procedure TPCPurchaseClothStatisticForm.Button2Click(Sender: TObject);
var I :integer;
    SelectStr1 :string;
begin
  inherited;

inherited PCBrPurchaseBForm: TPCBrPurchaseBForm
  Left = 48
  Top = 194
  Width = 808
  Height = 580
  ...
  inherited Panel1: TPanel
    ...
    inherited PageControl: TPageControl
      ...
      inherited TabSheet1: TTabSheet
        Caption = #37319#36141#36827#36135#36164#26009
      end
    end
  ...
  object adsSalesMaster: TADODataSet
    ...
    Filtered = True
    CommandText = 
      'select a.ID,a.ClientID ,a. EmployeeID,a.RecordState,a.Code as ['#32534 +
      #21495'],a.Date ['#26085#26399'],  a.BillMode ['#19994#21153#31867#21035'],'#13#10'a.ClearDate ['#32467#31639#26085#26399'], a.Appor' +
      'tion ['#20998#25674#35201#27714'], '#13#10'a.Deliver ['#36865#36135#35201#27714'], a.Memo ['#22791#27880'],b.name as ['#23458#25143#21517#31216'] '#13#10 +
      ',c.name as ['#32463#25163#20154'], A.SundryFee*a.ModeDC*a.ModeC  as ['#38468#21152#36153#29992'] ,'#13#10'ttl' +
      '.Amount*a.ModeDC*a.ModeC as ['#37329#39069'] ,'#13#10'ttl.Discount*a.ModeDC*a.Mode' +
      'C as ['#25240#25187#37329#39069'],'#13#10'a.Recordstate as ['#20973#21333#29366#24577']'#13#10'from PCPurchaseMaster a '#13 +
      #10'left outer join  DAClient b on b. ID=a.ClientID '#13#10'left outer jo' +
      'in  MSEmployee  c on c.id=a. EmployeeID   '#13#10'left outer join '#13#10'(s' +
      'elect masterID, (sum(isnull(Amount,0))+Sum(Isnull(TaxAmount,0))+' +
      #13#10'Sum(Isnull(SundryFee,0))) as Amount ,sum(isnull(Discount,0)) a' +
      's Discount'#13#10'from PCPurchaseDetail group by masterId  ) as ttl '#13#10 +
      'on ttl.masterID=a.id '#13#10'WHERE  A.RECORDSTATE<>'#39#21024#38500#39' '#13#10'order by a.I' +
      'D DESC'
    Parameters = <>
    Left = 192
    Top = 108

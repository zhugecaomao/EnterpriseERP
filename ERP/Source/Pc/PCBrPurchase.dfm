inherited PCBrPurchaseForm: TPCBrPurchaseForm
  Left = 156
  Top = 189
  Width = 606
  Height = 342
  ...
  object adsSalesMaster: TADODataSet
    ...
    CommandText = 
      ...
      '['#32534#21495'],a.Date ['#26085#26399'],  a.BillMode ['#19994#21153#31867#21035'],'#13#10'b.name as ['#21378#21830#21517#31216'] ,'#13#10'ttl.A' +
      'mount*a.ModeDC*a.ModeC as ['#37319#36141#37329#39069'] ,'#13#10'A.SundryFee*a.ModeDC*a.ModeC' +
      '  as ['#38468#21152#36153#29992'] ,'#13#10'c.name as ['#32463#25163#20154'], '#13#10'a.ClearDate ['#32467#31639#26085#26399'],'#13#10'a.Deliver' +
      '  ['#36865#36135#35201#27714'],'#13#10'a.Memo ['#22791#27880'],'#13#10'a.Recordstate as ['#20973#21333#29366#24577']'#13#10'from PCPurchas' +
      'eMaster a '#13#10'left outer join  DAClient b on b. ID=a.ClientID '#13#10'le' +
      'ft outer join  MSEmployee  c on c.id=a. EmployeeID   '#13#10'left oute' +
      'r join '#13#10'(select masterID, (sum(isnull(Amount,0))+Sum(Isnull(Tax' +
      'Amount,0))+'#13#10'Sum(Isnull(SundryFee,0))) as Amount ,sum(isnull(Dis' +
      'count,0)) as Discount'#13#10'from PCPurchaseDetail group by masterId  ' +
    ...
    object adsSalesMasterDSDesigner5: TBCDField
      FieldName = #37319#36141#37329#39069
      ReadOnly = True
      DisplayFormat = '#,#.00'
      Precision = 38
    ...
    object adsSalesMasterDSDesigner6: TBCDField
      FieldName = #38468#21152#36153#29992
      ReadOnly = True
      DisplayFormat = '#,#.00'
      Precision = 38
    ...
    object adsSalesMasterDSDesigner8: TDateTimeField
      FieldName = #32467#31639#26085#26399
    end

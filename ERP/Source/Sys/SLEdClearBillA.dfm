inherited SLEdClearBillAForm: TSLEdClearBillAForm
  Left = 75
  Top = 141
  Width = 718
  Height = 461
  ...
  object tblSLClearBillDetail: TADODataSet
    ...
    CommandText = 'select *'#13#10'from SLClearBillDetail'#13#10'where MasterID = :ID'
    Parameters = <
      item
        Name = 'ID'
  ...
  object tblSLClearBillMaster: TADODataSet
    ...
    CursorType = ctStatic
    CommandText = 
      'select *'#13#10'from SLClearBillMaster'#13#10'where RecordState<>'#39#21024#38500#39' and ID' +
      '=:ID'
    Parameters = <
      item
        Name = 'ID'

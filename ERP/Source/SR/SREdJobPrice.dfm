inherited SREdJobPriceForm: TSREdJobPriceForm
  Left = 118
  Top = 95
  Width = 668
  Height = 461
  Caption = #35745#20214#24037#20215
  ...
  inherited TopPanel: TPanel
    ...
    object BitBtn1: TBitBtn
      ...
      Caption = #21462#35745#20214#39033#30446
      TabOrder = 8
  ...
  object JobsLookup: TQLDBLookupComboBox [5]
    Left = 16
    Top = 168
    Width = 121
    Height = 18
  ...
  object AdsSRJobs: TADODataSet
    Connection = CommonData.acnConnection
    CursorType = ctStatic
    CommandText = 'select * from SRJobs'#13#10'where RecordState<>'#39#21024#38500#39' '
    Parameters = <>
    Left = 172
    Top = 259
  end
  ...
  object adsMaster: TADODataSet
    ...
    Filtered = True
    CommandText = 
      'select *'#13#10'from SRJobsPriceMaster'#13#10'where RecordState<>'#39#21024#38500#39' and ID' +
      '=:ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
  ...
  object adsDetail: TADODataSet
    ...
    CommandText = 'select *'#13#10'from SRJobsPriceDetail'#13#10'where MasterID = :ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
        Name = 'ID'
    ...
    object adsDetailJobs: TStringField
      DisplayLabel = #35745#20214#39033#30446#21517#31216
      FieldKind = fkLookup
      FieldName = 'Jobs'
    ...
    object adsDetailAmount: TBCDField
      DisplayLabel = #21442#32771#21333#20215
      FieldName = 'Amount'
      DisplayFormat = '#,#0.000'
      Precision = 19
      Size = 5

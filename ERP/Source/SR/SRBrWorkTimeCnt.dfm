inherited SRBrWorkTimeCntForm: TSRBrWorkTimeCntForm
  Left = 84
  Top = 93
  Width = 653
  Height = 471
  ...
  inherited Panel1: TPanel
    ...
    inherited PageControl: TPageControl
      ...
      inherited TabSheet1: TTabSheet
        Caption = #35745#26102#32479#35745#36164#26009
      end
    end
    inherited DBGrid: TQLDBGrid
      ...
      Columns = <
        ...
        item
          Expanded = False
          FieldName = #35745#26102#26399#38388
          Title.Alignment = taCenter
          Width = 120
          Visible = True
        end
        item
          Expanded = False
          FieldName = #35745#26102#26085#26399
          Title.Alignment = taCenter
          Width = 90
          Visible = True
        end
  ...
  object adsMaster: TADODataSet
    ...
    CommandText = 
      ...
      'ef ['#35745#20214#26399#38388'], '#13#10'ClearDate ['#35745#20214#26085#26399'], Memo ['#22791#27880'],a.RecordState ['#21333#25454#29366#24577'],a.' +
      'RecordState'#13#10'from SRWorkTimeCntMaster a '#13#10'left outer join MSEmpl' +
      'oyee b on b.ID=a.EmployeeID '#13#10'left outer join MSEmployee c on c.' +
      'ID=a.ClientID '#13#10#13#10'where a.RecordState<>'#39#21024#38500#39#13#10
    Parameters = <>
    Left = 160
    Top = 108
    ...
    object adsMasterDSDesigner6: TStringField
      FieldName = #35745#20214#26399#38388
      Size = 30
    end
    object adsMasterDSDesigner7: TDateTimeField
      FieldName = #35745#20214#26085#26399
    end

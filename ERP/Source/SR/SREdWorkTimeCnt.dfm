inherited SREdWorkTimeCntForm: TSREdWorkTimeCntForm
  ...
  object AdsSRJobs: TADODataSet
    ...
    CommandText = 
      ...
      'cordState<>'#39#21024#38500#39' '#13#10'and 1=2'
    Parameters = <>
    Left = 91
    Top = 255
  end
  ...
  object adsMaster: TADODataSet
    ...
    Filtered = True
    CommandText = 
      'select *'#13#10'from SRWorkTimeCntMaster'#13#10'where RecordState<>'#39#21024#38500#39' and ' +
      'ID=:ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
  ...
  object adsDetail: TADODataSet
    ...
    CommandText = 'select *'#13#10'from SRWorkTimeCntDetail'#13#10'where MasterID = :ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
        Name = 'ID'
    ...
    object adsDetailJobs: TStringField
      DisplayLabel = #35745#26102#39033#30446#21517#31216
      FieldKind = fkLookup
      FieldName = 'Jobs'

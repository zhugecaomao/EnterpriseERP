inherited DAGoodsBrowseForm: TDAGoodsBrowseForm
  Left = 23
  Top = 201
  Width = 767
  Height = 364
  ...
  inherited Panel1: TPanel
    ...
    inherited DBGrid: TQLDBGrid
      ...
      Columns = <
        ...
        item
          Expanded = False
          FieldName = #21830#21697#26465#30721
          Title.Alignment = taCenter
          Width = 160
          Visible = True
        end
        ...
        item
          Expanded = False
          FieldName = #21442#32771#38144#20215
          Title.Alignment = taCenter
          Width = 100
          Visible = True
        end
  ...
  object tblDAGoods: TADODataSet
    ...
    CommandText = 
      ...
      'Pictrue,a.GoodsClassID, a.UnitID,a.AddUnitID ,'#13#10'a.Name ['#21830#21697#21517#31216'], C' +
      'ode ['#21830#21697#32534#30721'],'#13#10'a.Spec ['#35268#26684#22411#21495'],a.BarCode ['#21830#21697#26465#30721'],'#13#10'b.name as ['#21830#21697#20998#31867'] ,' +
      #13#10'a.PricePurchase ['#21442#32771#36827#20215'],a.PriceSales ['#21442#32771#38144#20215'],   '#13#10'a.StockMin ['#26368#20302 +
      #24211#23384'], a.StockMax ['#26368#22823#24211#23384'], '#13#10'd.name ['#36741#21161#21333#20301'], a.AddUnitRate ['#36741#21161#25442#31639#29575'], ' +
      #13#10'c.name ['#26631#20934#21333#20301']'#13#10'from DAGoods a'#13#10'left outer  join  DAGoodsClass ' +
      'b on b.ID=a.GoodsClassID'#13#10'left outer  join  MSUnit c on c.ID=a.U' +
      'nitID'#13#10'left outer  join  MSUnit d on d.ID=a.AddUnitID'#13#10'where a. ' +
      'RecordState<>'#39#21024#38500#39' and '#13#10'a. GoodsClassID in (select Id from  DAGo' +
      'odsClass where LevelCode  like :LevelCode1)'
    Parameters = <
      item
        Name = 'LevelCode1'
        Size = -1

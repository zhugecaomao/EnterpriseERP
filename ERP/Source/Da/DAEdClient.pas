...
type
  TDAClientEditForm = class(TWSStandardEditForm)
...
var
  DAClientEditForm: TDAClientEditForm;
...
{$R *.dfm}
function TDAClientEditForm.Enter(const Params: Variant): Boolean;
begin
  tblClientEdit.Open;
  adotable1.Open;
  ...
  tblClientEdit.FieldByName('ClientType').AsString := '客户';
  DBComboBox1.ItemIndex :=0;
  Result := ShowModal = mrOK;
end;
function TDAClientEditForm.Edit(const Params: Variant): Boolean;
begin
  tblClientEdit.Open;
  adotable1.Open;
...
procedure TDAClientEditForm.OKButtonClick(Sender: TObject);
begin
  inherited;
    tblClientEdit.Post;
  modalresult:=mrOk;
...
procedure TDAClientEditForm.CancelButtonClick(Sender: TObject);
begin
  inherited;
  modalresult:=mrcancel;
end;

procedure TDAClientEditForm.FormCreate(Sender: TObject);
begin
  inherited;
pagecontrol1.ActivePageIndex:=0;
end;

procedure TDAClientEditForm.tblClientEditBeforePost(DataSet: TDataSet);
begin
  inherited;
...
procedure TDAClientEditForm.FormClose(Sender: TObject;
...
procedure TDAClientEditForm.ADOTable1FilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
  inherited;
...
procedure TDAClientEditForm.tblClientEditFilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
  inherited;
...
procedure TDAClientEditForm.FormShow(Sender: TObject);
begin
  inherited;
 dbedit1.SetFocus;
 dbedit1.SelLength:=0;
...
procedure TDAClientEditForm.SpeedButton1Click(Sender: TObject);
...
begin
  ...
  begin
    ...
    sql.Text := 'update DaClient set GeneralACID='+ ACIDStr
       +' where ClientType='+Quotedstr('客户')
       +' or ClientType='+Quotedstr('客户和厂商') ;
    ExecSql;
  end;
end;

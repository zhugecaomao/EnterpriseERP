inherited STEdYDGoodsOutCostForm: TSTEdYDGoodsOutCostForm
  Left = 2
  Top = 134
  Width = 808
  Height = 580
  ...
  object adsMaster: TADODataSet
    ...
    Filtered = True
    CommandText = 
      'select *'#13#10'from STYDGoodsOutCostMaster'#13#10'where RecordState<>'#39#21024#38500#39' a' +
      'nd ID=:ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
  ...
  object adsDetail: TADODataSet
    ...
    CommandText = 'select *'#13#10'from STYDGoodsOutCostDetail'#13#10'where MasterID = :ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
        Name = 'ID'

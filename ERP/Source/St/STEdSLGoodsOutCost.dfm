inherited STEdSLGoodsOutCostForm: TSTEdSLGoodsOutCostForm
  ...
  object adsMaster: TADODataSet
    ...
    Filtered = True
    CommandText = 
      'select *'#13#10'from STSLGoodsOutCostMaster'#13#10'where RecordState<>'#39#21024#38500#39' a' +
      'nd ID=:ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
  ...
  object adsDetail: TADODataSet
    ...
    CommandText = 'select *'#13#10'from  STSLGoodsOutCostDetail'#13#10'where MasterID = :ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
        Name = 'ID'

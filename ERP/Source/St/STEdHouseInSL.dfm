inherited STHouseInEditSLForm: TSTHouseInEditSLForm
  Left = 157
  Top = 187
  Width = 614
  Height = 413
  ...
  object adsSTHouseOutMaster: TADODataSet
    Connection = CommonData.acnConnection
    CommandText = 
      'SELECT * FROM STHouseInMaster  WHERE ID = :ID and RecordState <>' +
      #39#21024#38500#39
    Parameters = <
      item
        Name = 'ID'
  ...
  object adsSTHouseOutDetail: TADODataSet
    ...
    CommandText = 'SELECT * FROM STHouseInDetail  WHERE MasterID = :ID'
    Parameters = <
      item
        Name = 'ID'
    ...
    object adsSTHouseOutDetailGoalUnitID: TIntegerField

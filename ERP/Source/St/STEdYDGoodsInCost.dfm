inherited STEdYDGoodsInCostForm: TSTEdYDGoodsInCostForm
  Left = -98
  Top = 74
  Width = 808
  Height = 580
  ...
  object adsMaster: TADODataSet
    ...
    Filtered = True
    CommandText = 
      'select *'#13#10'from STYDGoodsInCostMaster'#13#10'where RecordState<>'#39#21024#38500#39' an' +
      'd ID=:ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
  ...
  object adsDetail: TADODataSet
    ...
    CommandText = 'select *'#13#10'from STYDGoodsInCostDetail'#13#10'where MasterID = :ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
        Name = 'ID'

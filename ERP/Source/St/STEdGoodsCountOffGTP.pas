...
type
  TSTEdGoodsCountOffGTPForm = class(TBaseVoucherEditForm)
    Label1: TLabel;
    Label2: TLabel;
    Label3: TLabel;
...
var
  STEdGoodsCountOffGTPForm: TSTEdGoodsCountOffGTPForm;

implementation

uses CommonDM, WSUtils, WSSecurity;
{$R *.dfm}
procedure TSTEdGoodsCountOffGTPForm.New;
begin
  inherited;
...
procedure TSTEdGoodsCountOffGTPForm.Open(VoucherID: Integer);
begin
  inherited Open(VoucherID);
end;


procedure TSTEdGoodsCountOffGTPForm.FormClose(Sender: TObject;
...
procedure TSTEdGoodsCountOffGTPForm.FormCreate(Sender: TObject);
...
procedure TSTEdGoodsCountOffGTPForm.FormShow(Sender: TObject);
...
procedure TSTEdGoodsCountOffGTPForm.adsDetailGoodsIDChange(Sender: TField);
...
procedure TSTEdGoodsCountOffGTPForm.adsDetailGoalQuantityChange(Sender: TField);
var   ExChRate :real;
begin
...
procedure TSTEdGoodsCountOffGTPForm.FormActivate(Sender: TObject);
begin
  inherited;
  ClientQLDBLookup.SetFocus;
end;

procedure TSTEdGoodsCountOffGTPForm.LookupPackUintEnter(Sender: TObject);
...
procedure TSTEdGoodsCountOffGTPForm.LookupPackUintExit(Sender: TObject);
begin

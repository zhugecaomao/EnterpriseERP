inherited STHouseInBrowseSLForm: TSTHouseInBrowseSLForm
  Left = 132
  Top = 166
  Caption = #36864#36135#20837#24211
  ...
  object ADODataSet1: TADODataSet
    ...
    CommandText = 
      ...
      'e,a.memo'#13#10' from STHouseInMaster as a '#13#10' left join MSEmployee as ' +
      'b on a.ConsigneeID=b.ID'#13#10' left join MSEmployee as c on a.Employe' +
      'eID=c.ID'#13#10' left join STWarehouse as e on a.WarehouseID=e.ID'#13#10' le' +
      'ft join DABillType as f on a.OriginBillTypeID= f.ID'#13#10' where a.Re' +
    ...
    object ADODataSet1HouseOut: TStringField
      DisplayLabel = #20837#24211#20998#31867
      DisplayWidth = 10
      FieldName = 'HouseOut'
      Size = 12
    end
    object ADODataSet1ConsigneeName: TStringField
      DisplayLabel = #20837#24211#20154
      DisplayWidth = 10

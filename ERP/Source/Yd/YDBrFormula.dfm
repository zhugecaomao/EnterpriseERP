inherited YDBrFormulaForm: TYDBrFormulaForm
  Left = -4
  Top = -4
  Width = 808
  Height = 580
  ...
  inherited Panel1: TPanel
    ...
    inherited PageControl: TPageControl
      ...
      inherited TabSheet1: TTabSheet
        Caption = #29289#26009#28165#21333#36164#26009
      end
    end
  ...
  object adsMaster: TADODataSet
    ...
    CommandText = 
      ...
      #29366#24577']'#13#10'from YDFormulaMaster a '#13#10'left outer join  MSEmployee  b on ' +
      'b. ID=a.ClientID '#13#10'left outer join  MSEmployee  c on c.id=a. Emp' +
      'loyeeID   '#13#10'WHERE  A.RECORDSTATE<>'#39#21024#38500#39' '#13#10'order by a.ID DESC'
    Parameters = <>
    Left = 192
    Top = 132

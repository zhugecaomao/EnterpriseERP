inherited YDEdGoodsInGTPForm: TYDEdGoodsInGTPForm
  Left = -4
  Top = -4
  Width = 808
  Height = 580
  Caption = #20837#24211#20973#21333
  ...
  inherited TopPanel: TPanel
    ...
    object Label7: TLabel [7]
      ...
      Width = 48
      Height = 12
      Caption = #20445#36136#26085#26399
    end
    ...
    object Label4: TLabel [9]
      ...
      Width = 72
      Height = 12
      Caption = #29983#20135#35745#21010#32534#21495
    end
    ...
    object OriginCode: TQLDBLookupComboBox
      Left = 510
      Top = 100
      Width = 140
      Height = 20
      ...
      KeyField = 'ID'
      ListField = 'code'
      ListSource = DsYDProductPlanCode
      OnClick = OriginCodeClick
      ParentCtl3D = False
      TabOrder = 8
      ButtonHeight = 22
      SearchMode = smLocate
  ...
  object adsMaster: TADODataSet
    ...
    Filtered = True
    CommandText = 
      'select *'#13#10'from YDGoodsInMaster'#13#10'where RecordState<>'#39#21024#38500#39' and ID=:' +
      'ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
  ...
  object adsDetail: TADODataSet
    ...
    CommandText = 'select *'#13#10'from YDGoodsInDetail'#13#10'where MasterID = :ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
        Name = 'ID'
    ...
    object adsDetailPriceGoal: TBCDField
      DisplayLabel = #26680#31639#21333#20301#25104#26412
      FieldName = 'PriceGoal'
      OnChange = adsDetailGoalQuantityChange
      DisplayFormat = '#.000'
      Precision = 19
    ...
    object adsDetailAmount: TBCDField
      DisplayLabel = #26680#31639#25104#26412#37329#39069
      FieldName = 'Amount'
      Visible = False
      DisplayFormat = '#,#.00'
      Precision = 19

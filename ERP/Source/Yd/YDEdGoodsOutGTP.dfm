inherited YDEdGoodsOutGTPForm: TYDEdGoodsOutGTPForm
  Left = 112
  Top = 109
  Width = 668
  Height = 461
  Caption = #39046#26009#20973#21333
  ...
  inherited TopPanel: TPanel
    ...
    object DBComboBox1: TDBComboBox
      ...
      ItemHeight = 12
      Items.Strings = (
        #29983#20135#39046#26009
        #22806#22996#39046#26009
        #28040#32791#39046#26009)
      TabOrder = 5
    end
  end
  ...
  object adsMaster: TADODataSet
    ...
    Filtered = True
    CommandText = 
      'select *'#13#10'from YDGoodsOutMaster'#13#10'where RecordState<>'#39#21024#38500#39' and ID=' +
      ':ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
  ...
  object adsDetail: TADODataSet
    ...
    CommandText = 'select *'#13#10'from YDGoodsOutDetail'#13#10'where MasterID = :ID'
    IndexFieldNames = 'ID'
    Parameters = <
      item
        Name = 'ID'
    ...
    object adsDetailGoodsName: TStringField
      DisplayLabel = #21830#21697#36164#26009
      FieldKind = fkLookup
      FieldName = 'GoodsName'
